...
class Boule_coloree(
    ...
    def dessinimage(self, qp):
        ...
        qp.drawImage(QtCore.QRect(10+40+ self.x , 701 - self.y + 10 + 76.2 )) #10+76.2+51.3+ 90 +621 - self.y,20,20), self.image)   #à tester
...
class Boule_blanche(Boule):  # on définit la classe représentant les boules colorées,
    ...
    def dessinimage(self, qp):
        #qp.drawImage(QtCore.QRect(self.x - 10, self.y - 10, 20, 20), self.image)
        qp.drawImage(QtCore.QRect(10+ 40+self.x ,701- self.y + 10 + 76.2))   #10+76.2 + 51.3 + 90+ 621- self.y, 20, 20), self.image)
